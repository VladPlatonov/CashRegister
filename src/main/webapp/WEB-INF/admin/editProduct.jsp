...
<div class="wrapper fadeInDown">
    <div id="formContent">
        ...
        <form name="editProduct" method="post" action="/products" >
            ...
            <input type="number" min ="0" name="cost"class="number" required placeholder="<fmt:message key="addProduct.cost"/>" value="${product.cost}" >
            ...
            <input hidden type="text" name="productAction" value="u!editProduct_update">
